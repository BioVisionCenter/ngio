...
- **Parallel iteration**: `map`/`reduce` fan out on threads or processes via `mapper=ThreadedMapper(...)` / `ProcessMapper(...)`, lock-free by construction.
