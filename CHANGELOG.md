...
- **Parallel mappers validate `max_workers` at construction**: `0` or a negative — previously clamped to 1, i.e. silently serial under the flag that asked for parallelism — now raise.
